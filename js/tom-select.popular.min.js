...
g[s]=t}}const v=new RegExp(Object.keys(g).join("|")+"|[̀-ͯ·ʾʼ]","gu"),m=(t,e="NFKD")=>t.normalize(e),y=t=>Array.from(t).reduce(((t,e)=>t+b(e)),""),b=t=>(t=m(t).toLowerCase().replace(v,(t=>g[t]||"")),m(t,"NFC"))
const O=t=>{const e={},i=(t,i)=>{const s=e[t]||new Set,n=new RegExp("^"+o(s)+"$","iu")
...
i.initEvent(e,!0,!1),t.dispatchEvent(i)},q=(t,e)=>{Object.assign(t.style,e)},D=(t,...e)=>{var i=H(e);(t=R(t)).map((t=>{i.map((e=>{t.classList.add(e)}))}))},N=(t,...e)=>{var i=H(e);(t=R(t)).map((t=>{i.map((e=>{t.classList.remove(e)}))}))},H=e=>{var i=[]
return t.iterate(e,(t=>{"string"==typeof t&&(t=t.trim().split(/[\11\12\14\15\40]/)),Array.isArray(t)&&(i=i.concat(t))})),i.filter(Boolean)},R=t=>(Array.isArray(t)||(t=[t]),t),M=(t,e,i)=>{if(!i||i.contains(t))for(;t&&t.matches;){if(t.matches(e))return t
...
t&&(p=t.textContent)}var h,g,f,v,m,y,b={placeholder:p,options:[],optgroups:[],items:[],maxItems:null}
return"select"===u?(g=b.options,f={},v=1,m=t=>{var e=Object.assign({},t.dataset),i=n&&e[n]
return"string"==typeof i&&i.length&&(e=Object.assign(e,JSON.parse(i))),e},y=(t,e)=>{var i=W(t.value)
if(null!=i&&(i||s.allowEmptyOption)){if(f.hasOwnProperty(i)){if(e){var n=f[i][a]
n?Array.isArray(n)?n.push(e):f[i][a]=[n,e]:f[i][a]=e}}else{var c=m(t)
c[o]=c[o]||t.textContent,c[r]=c[r]||i,c[l]=c[l]||t.disabled,c[a]=c[a]||e,c.$option=t,f[i]=c,g.push(c)}t.selected&&b.items.push(i)}},b.maxItems=e.hasAttribute("multiple")?null:1,t.iterate(e.children,(e=>{var i,s,n
"optgroup"===(h=e.tagName.toLowerCase())?((n=m(i=e))[c]=n[c]||i.getAttribute("label")||"",n[d]=n[d]||v++,n[l]=n[l]||i.disabled,b.optgroups.push(n),s=n[d],t.iterate(i.children,(t=>{y(t,s)}))):"option"===h&&y(e)}))):(()=>{const i=e.getAttribute(n)
if(i)b.options=JSON.parse(i),t.iterate(b.options,(t=>{b.items.push(t[r])}))
else{var l=e.value.trim()||""
if(!s.allowEmptyOption&&!l.length)return
const i=l.split(s.delimiter)
t.iterate(i,(t=>{const e={}
e[o]=t,e[r]=t,b.options.push(e)})),b.items=i}})(),Object.assign({},U,b,i)}var at=0
...
const n=lt(s,e)
this.settings=n,this.input=s,this.tabIndex=s.tabIndex||0,this.is_select_tag="select"===s.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.inputId=nt(s,"tomselect-"+at),this.isRequired=s.required,this.sifter=new T(this.options,{diacritics:n.diacritics}),n.mode=n.mode||(1===n.maxItems?"single":"multi"),"boolean"!=typeof n.hideSelected&&(n.hideSelected="multi"===n.mode),"boolean"!=typeof n.hidePlaceholder&&(n.hidePlaceholder="multi"!==n.mode)
...
rt(l,n)}else rt(l,e)})),O.innerHTML="",rt(O,l),h.settings.highlight&&(v=O.querySelectorAll("span.highlight"),Array.prototype.forEach.call(v,(function(t){var e=t.parentNode
e.replaceChild(t.firstChild,t),e.normalize()})),m.query.length&&m.tokens.length&&E(m.tokens,(t=>{G(O,t.regex)})))
