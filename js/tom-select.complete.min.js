...
g[s]=e}}const v=new RegExp(Object.keys(g).join("|")+"|[̀-ͯ·ʾʼ]","gu"),m=(e,t="NFKD")=>e.normalize(t),b=e=>Array.from(e).reduce(((e,t)=>e+y(t)),""),y=e=>(e=m(e).toLowerCase().replace(v,(e=>g[e]||"")),m(e,"NFC"))
const O=e=>{const t={},i=(e,i)=>{const s=t[e]||new Set,n=new RegExp("^"+o(s)+"$","iu")
...
return e=e.map((e=>(p[e]&&(i+=e.length),p[e]||e))),i>=t?n(e):""})(e,t))))),I=(e,t=!0)=>{let i=e.length>1?1:0
...
return r&&s.items.sort(r),s.total=s.items.length,"number"==typeof t.limit&&(s.items=s.items.slice(0,t.limit)),s}}const j=e=>{if(e.jquery)return e[0]
if(e instanceof HTMLElement)return e
if(q(e)){var t=document.createElement("template")
return t.innerHTML=e.trim(),t.content.firstChild}return document.querySelector(e)},q=e=>"string"==typeof e&&e.indexOf("<")>-1,V=(e,t)=>{var i=document.createEvent("HTMLEvents")
i.initEvent(t,!0,!1),e.dispatchEvent(i)},D=(e,t)=>{Object.assign(e.style,t)},N=(e,...t)=>{var i=z(t);(e=M(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))},H=(e,...t)=>{var i=z(t);(e=M(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))},z=t=>{var i=[]
return e.iterate(t,(e=>{"string"==typeof e&&(e=e.trim().split(/[\11\12\14\15\40]/)),Array.isArray(e)&&(i=i.concat(e))})),i.filter(Boolean)},M=e=>(Array.isArray(e)||(e=[e]),e),R=(e,t,i)=>{if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
e=e.parentNode}},B=(e,t=0)=>t>0?e[e.length-1]:e[0],K=(e,t)=>{if(!e)return-1
t=t||e.nodeName
for(var i=0;e=e.previousElementSibling;)e.matches(t)&&i++
return i},Q=(t,i)=>{e.iterate(i,((e,i)=>{null==e?t.removeAttribute(i):t.setAttribute(i,""+e)}))},G=(e,t)=>{e.parentNode&&e.parentNode.replaceChild(t,e)},U=(e,t)=>{if(null===t)return
...
function ae(t,i){var s=Object.assign({},W,i),n=s.dataAttr,o=s.labelField,r=s.valueField,l=s.disabledField,a=s.optgroupField,c=s.optgroupLabelField,d=s.optgroupValueField,u=t.tagName.toLowerCase(),p=t.getAttribute("placeholder")||t.getAttribute("data-placeholder")
if(!p&&!s.allowEmptyOption){let e=t.querySelector('option[value=""]')
e&&(p=e.textContent)}var h,g,f,v,m,b,y={placeholder:p,options:[],optgroups:[],items:[],maxItems:null}
return"select"===u?(g=y.options,f={},v=1,m=e=>{var t=Object.assign({},e.dataset),i=n&&t[n]
return"string"==typeof i&&i.length&&(t=Object.assign(t,JSON.parse(i))),t},b=(e,t)=>{var i=X(e.value)
if(null!=i&&(i||s.allowEmptyOption)){if(f.hasOwnProperty(i)){if(t){var n=f[i][a]
n?Array.isArray(n)?n.push(t):f[i][a]=[n,t]:f[i][a]=t}}else{var c=m(e)
c[o]=c[o]||e.textContent,c[r]=c[r]||i,c[l]=c[l]||e.disabled,c[a]=c[a]||t,c.$option=e,f[i]=c,g.push(c)}e.selected&&y.items.push(i)}},y.maxItems=t.hasAttribute("multiple")?null:1,e.iterate(t.children,(t=>{var i,s,n
"optgroup"===(h=t.tagName.toLowerCase())?((n=m(i=t))[c]=n[c]||i.getAttribute("label")||"",n[d]=n[d]||v++,n[l]=n[l]||i.disabled,y.optgroups.push(n),s=n[d],e.iterate(i.children,(e=>{b(e,s)}))):"option"===h&&b(t)}))):(()=>{const i=t.getAttribute(n)
if(i)y.options=JSON.parse(i),e.iterate(y.options,(e=>{y.items.push(e[r])}))
else{var l=t.value.trim()||""
if(!s.allowEmptyOption&&!l.length)return
const i=l.split(s.delimiter)
e.iterate(i,(e=>{const t={}
t[o]=e,t[r]=e,y.options.push(t)})),y.items=i}})(),Object.assign({},W,y,i)}var ce=0
...
const n=ae(s,t)
this.settings=n,this.input=s,this.tabIndex=s.tabIndex||0,this.is_select_tag="select"===s.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.inputId=oe(s,"tomselect-"+ce),this.isRequired=s.required,this.sifter=new T(this.options,{diacritics:n.diacritics}),n.mode=n.mode||(1===n.maxItems?"single":"multi"),"boolean"!=typeof n.hideSelected&&(n.hideSelected="multi"===n.mode),"boolean"!=typeof n.hidePlaceholder&&(n.hidePlaceholder="multi"!==n.mode)
...
var p
if(N(r,n.wrapperClass,d,u),N(l,n.controlClass),le(r,l),N(a,n.dropdownClass,u),n.copyClassesToDropdown&&N(a,d),N(c,n.dropdownContentClass),le(a,c),j(n.dropdownParent||r).appendChild(a),q(n.controlInput)){p=j(n.controlInput)
...
i&&(e.onOptionSelect(t,i),ie(t,!0))})),se(r,"click",(t=>{var s=R(t.target,"[data-ts-item]",r)
...
se(document,"mousedown",v),se(window,"scroll",m,d),se(window,"resize",m,d),this._destroy=()=>{document.removeEventListener("mousedown",v),window.removeEventListener("scroll",m),window.removeEventListener("resize",m),g&&g.removeEventListener("click",f)},this.revertSettings={innerHTML:a.innerHTML,tabIndex:a.tabIndex},a.tabIndex=-1,a.insertAdjacentElement("afterend",e.wrapper),e.sync(!1),t.items=[],delete t.optgroups,delete t.options,se(a,"invalid",(()=>{e.isValid&&(e.isValid=!1,e.isInvalid=!0,e.refreshState())})),e.updateOriginalInput(),e.refreshItems(),e.close(!1),e.inputState(),e.isSetup=!0,a.disabled?e.disable():e.enable(),e.on("change",this.onChange),N(a,"tomselected","ts-hidden-accessible"),e.trigger("initialize"),!0===t.preload&&e.preload()}setupOptions(e=[],t=[]){this.addOptions(e),E(t,(e=>{this.registerOptionGroup(e)}))}setupTemplates(){var e=this,t=e.settings.labelField,i=e.settings.optgroupLabelField,s={optgroup:e=>{let t=document.createElement("div")
...
var v,m=h.search(g),b=null,y=h.settings.shouldOpen||!1,O=h.dropdown_content
for(f&&(b=h.activeOption)&&(c=b.closest("[data-group]")),n=m.items.length,"number"==typeof h.settings.maxOptions&&(n=Math.min(n,h.settings.maxOptions)),n>0&&(y=!0),t=0;t<n;t++){let e=m.items[t]
if(!e)continue
...
let e=u[o]
void 0===e&&(e=document.createDocumentFragment(),p.push(o)),i>0&&(d=d.cloneNode(!0),Q(d,{id:l.$id+"-clone-"+i,"aria-selected":null}),d.classList.add("ts-cloned"),H(d,"active"),h.activeOption&&h.activeOption.dataset.value==n&&c&&c.dataset.group===o.toString()&&(b=d)),e.appendChild(d),u[o]=e}}h.settings.lockOptgroupOrder&&p.sort(((e,t)=>{const i=h.optgroups[e],s=h.optgroups[t]
...
t.replaceChild(e.firstChild,e),t.normalize()})),m.query.length&&m.tokens.length&&E(m.tokens,(e=>{U(O,e.regex)})))
var w=e=>{let t=h.render(e,{input:g})
return t&&(y=!0,O.insertBefore(t,O.firstChild)),t}
if(h.loading?w("loading"):h.settings.shouldLoad.call(h,g)?0===m.items.length&&w("no_results"):w("not_loading"),(a=h.canCreate(g))&&(d=w("option_create")),h.hasOptions=m.items.length>0||a,y){if(m.items.length>0){if(b||"single"!==h.settings.mode||null==h.items[0]||(b=h.getOption(h.items[0])),!O.contains(b)){let e=0
d&&!h.settings.addPrecedence&&(e=1),b=h.selectable()[e]}}else d&&(b=d)
e&&!h.isOpen&&(h.open(),h.scrollToOption(b,"auto")),h.setActiveOption(b)}else h.clearActiveOption(),e&&h.isOpen&&h.close(!1)}selectable(){return this.dropdown_content.querySelectorAll("[data-selectable]")}addOption(e,t=!1){const i=this
